...
public final class LigneBDDHelper implements BaseColumns {
	...
	public static LigneModel cursorToLigneModel(Cursor c) {
		return new LigneModel(c.getInt(NUM_COL_ID), c.getString(c.getColumnIndex(TypeLigneBDDHelper.COL_TYPE_LIGNE)), c.getString(c.getColumnIndex(COL_NOM_LIGNE)), c.getInt(c.getColumnIndex(COL_IS_FAVORIS)) == 0 ? false : true);
	}
}

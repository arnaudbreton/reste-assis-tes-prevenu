...
public class ImageNumLineSpinnerListAdapter extends ArrayAdapter<LigneModel> {
	...
	public ImageNumLineSpinnerListAdapter(Context context, int textViewResourceId,
	...
	public Drawable getImage(LigneModel ligne) {
		if(ligne != null) {
			int imageResource = getContext().getResources().getIdentifier(LigneModelService.getNumLigneImage(ligne.getTypeLigne(), ligne.getNumLigne()), "drawable", getContext().getPackageName());
			if(imageResource != 0) {
